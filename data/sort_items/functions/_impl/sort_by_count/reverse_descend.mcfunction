#> sort_items:_impl/sort_by_count/reverse_descend
...
data modify storage : _ append value {ascend:[[]]}
  ...
  execute if data storage : _[-1].descend[0] run function sort_items:_impl/sort_by_count/_impl/ascend/return_reverse
